(function( $ ) {
	...
	$(function() {
		...
		// Order meta box sync button handler
		jQuery('#mwxs_odp_ptx').on('click', function(e) {
			e.preventDefault();
			if (typeof mwxsSyncData !== 'undefined') {
				popUpWindow(
					mwxsSyncData.syncUrl + '&sync_type=push&item_ids=' + mwxsSyncData.orderId + '&item_type=order',
					'mw_xs_order_push',
					0, 0, 650, 350
				);
			}
