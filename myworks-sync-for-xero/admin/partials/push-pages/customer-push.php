...
<div class="container">
	<div class="page_title"><h4><?php esc_html_e( 'Customer Push', 'myworks-sync-for-xero' );?></h4></div>
								...
								<div class="row">
									<div class="input-field col s12 m12 14">
										<button id="push_selected_customer_btn" class="waves-effect waves-light btn save-btn mw-qbo-sync-green">
											<?php echo esc_html__('Push Selected Customers','myworks-sync-for-xero')?>
										</button>										
									</div>
								</div>
								<br>
										...
										<table id="mwqs_customer_push_table" class="table tablesorter">
											...
											<tbody>
												...
												<tr>
													...
													<td><?php echo esc_html($data['first_name']).' '.esc_html($data['last_name'])?></td>
