...
class Organisation implements ModelInterface, ArrayAccess
{
    ...
    {
        // MyWorks patch: accept unknown enum values from the Xero API instead of throwing —
        // new values (e.g. ULTRA plan, SINGLEMEMBERLLC) would otherwise fatal deserialization.
